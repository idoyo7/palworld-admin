    ...
    <div className="min-h-screen bg-[#0a0a0b] text-neutral-100">
      <div className="mx-auto max-w-6xl px-5 py-6 sm:px-8">
        <div className="mb-4 flex flex-wrap items-center justify-between gap-3">
          <div>
            <h1 className="text-xl font-bold text-neutral-100">팰월드 REST API 문서</h1>
            <p className="mt-1 text-sm text-neutral-400">
              이 문서는 palworld-admin 서버 프록시(<code className="rounded bg-white/10 px-1 py-0.5 text-xs">/api/palworld/*</code>)를
